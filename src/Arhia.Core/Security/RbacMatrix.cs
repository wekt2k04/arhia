...
public static class RbacMatrix
{
    private static readonly IReadOnlyDictionary<ResourceAction, IReadOnlySet<RoleType>> Default =
        new Dictionary<ResourceAction, IReadOnlySet<RoleType>>
        {
            ...
            [ResourceAction.EmployeeRead] = Roles(RoleType.Employee, RoleType.HR, RoleType.QualityAdmin),
            [ResourceAction.DepartmentRead] = Roles(RoleType.Employee, RoleType.HR, RoleType.QualityAdmin)
        };
